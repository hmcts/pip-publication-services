...
public class CivilDailyCauseListConverter implements Converter {
    ...
    public String convert(JsonNode artefact, Map<String, String> artefactValues) {
        ...
        context.setVariable("publicationDate", DateHelper.formatTimeStampToBst(publicationDate, false, false));
        context.setVariable("publicationTime", DateHelper.formatTimeStampToBst(publicationDate, true, false));
